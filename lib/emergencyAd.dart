...
class EmergencyAid extends StatefulWidget {
  const EmergencyAid({super.key});

  @override
  State<EmergencyAid> createState() => _EmergencyAidState();
}

class _EmergencyAidState extends State<EmergencyAid> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: StreamBuilder(
            stream:
                FirebaseFirestore.instance.collection('emgImage').snapshots(),
            builder: (context,
